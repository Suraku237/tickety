...
class ApiService {
  ...
  // GET /join/<join_token>
  // Validates the token against the DB and returns queue/service
  // info. Rejects anything that isn't a real Tickety token.
  // ----------------------------------------------------------
  ...
  // POST /join/<join_token>
  // Body: { customer_identifier: email }
  // The backend validates the join_token against the DB;
  // any token not generated by Tickety will return 404.
  // ----------------------------------------------------------
  ...
  // ----------------------------------------------------------
  // TICKETS — CREATE (legacy — kept for compatibility)
  // POST /tickets
  // ----------------------------------------------------------
  ...
  Future<Map<String, dynamic>> getTickets({
    ...
    // Backend filters by user_email or user_id
